...
import com.android.tools.sizereduction.analyzer.model.BundleConfigLocation;
            ...
            .setLibraryDependencies(
                ImmutableSet.of(
                    ...
                    Library.newBuilder()
                        ...
                        .build()))
            .setBundleConfig(
                BundleConfig.builder()
                    .setBundleConfigLocation(BundleConfigLocation.builder().build())
                    .build())
            .build();
